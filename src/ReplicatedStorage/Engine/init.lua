...
See README.md
https://github.com/QEngineermoreEngine/blob/version2/loader/ReplicatedStorage/Nevermore/README.md

In general usage is simple
1) Put this script, and all of its children in ReplicStorage.Engine (or your preferred parent)
...
local SERVER_SCRIPT_SERVICE_MODULES = "Framework"
